...
Буфер шарит данные между своими копиями пока значения не меняются. При создании клона увеличиваем счетчик. При изменении - создаем копию. РЕализованы проверки. Буфер следует закрывать после окончания использования
